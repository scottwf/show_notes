...
def main():
    ...
    print("\n📋 Next steps:")
    print("  1. Run: python3 run_migrations.py")
    print("  2. Run: python3 create_missing_tables.py")
    print("  3. Restart the Flask application")
    print("  4. Visit the app in your browser")
    print("  5. You will be redirected to onboarding")
    print("  6. Create admin account and configure services")
    print("  7. Use Admin > Tasks to sync Sonarr/Radarr libraries")
    print("  8. Use Admin > Tasks > 'Wipe & Fresh Import' to import Tautulli history\n")
