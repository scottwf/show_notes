...
def main():
    ...
    print("\n📋 Next steps:")
    print("  1. Initialize database: FLASK_APP=run.py flask init-db")
    print("  2. Start the Flask application: python3 run.py")
    print("  3. Visit the app in your browser")
    print("  4. You will be redirected to onboarding")
    print("  5. Create admin account and configure services")
    print("  6. Use Admin > Tasks to sync Sonarr/Radarr libraries\n")
